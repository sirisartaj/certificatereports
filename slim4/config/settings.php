...
define("SITE_KEY", "RestFul");
define("DB_PREFIX", "sg_");
define('UPLOADFILEPATH', $_SERVER['DOCUMENT_ROOT'] . '/slim4/public/uploads/');
define('UPLOADPATH', $_SERVER['DOCUMENT_ROOT'] .'/slim4/public/uploads/');
