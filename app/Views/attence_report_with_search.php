 ...
 <!-- BEGIN PAGE CONTENT -->
    <div class="page-content">
	  ...
	  <div class="panel">
        ...
        <div class="append-icon-default">
                  <div class="date form-date">
                    <input type="text" class="form-control form-white datetimepicker1" placeholder="Select date" id="course_id" name="course_id" value="<?php echo $course_id;?>">
                    <span class="add-on"><i class="icon-th"></i></span> </div>
                  <i class="icon-calendar default-date-icon"></i> </div>
       </div>
      </div> 
      ...
      <div class="col-sm-3">
        ...
        <div class="append-icon-default">
                  <div class="date form-date">
                    <input type="text" class="form-control form-white datetimepicker1" placeholder="Select date" id="section_id" name="section_id" value="<?php echo $section_id;?>">
                    <span class="add-on"><i class="icon-th"></i></span> </div>
                  <i class="icon-calendar default-date-icon"></i> </div>
       </div>
      </div> 
  ...
  var from_date= $('#from_date');
    ...
    oTable= $('#input_buttons').DataTable({
        processing: true,
          ...
          paging: true,
          ajax: {
              url: '<?php echo base_url().'/attendenceseachresults'?>',
              type: 'POST',
              data: {'from_date': $("#from_date").val(),'to_date':$("#to_date").val(),'course_id':$("#course_id").val(),'section_id':$("#section_id").val()},
          },
